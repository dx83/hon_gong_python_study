...
MODEL_PATH = ROOT / "pill_color_efficientnetb0.keras"
ENCODER_PATH = ROOT / "pill_color_encoder.pkl"
...
df_info["color_label"] = (
    df_info["색상앞"].str.strip()
    + "+"
    + df_info["색상뒤"].str.strip()
)

print(df_info["color_label"].value_counts().head(30))
print("색상 클래스 수 :", df_info["color_label"].nunique())
